...
class InvitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invite" do
    assert_difference('Invite.count') do
      post invites_url, params: { invite: { header_color: @invite.header_color, header_title: @invite.header_title, wedding_date: @invite.wedding_date } }
    end
  ...
  test "should update invite" do
    patch invite_url(@invite), params: { invite: { header_color: @invite.header_color, header_title: @invite.header_title, wedding_date: @invite.wedding_date } }
